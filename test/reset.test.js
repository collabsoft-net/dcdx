...
Object.values(SupportedApplications.Values).forEach(name => {
  ...
  describe(`dcdx reset - ${name}`, async () => {
    ...
    it(`dcdx reset (defaults with AMPS configuration for ${name} - legacy POM file)`, async () => {
      ...
      expect(stdErr).toBe('');
      expect(stdOut).toBe(`
Removing ${name} and deleting all data... 💔
Removed ${name} and deleted all data 💪
`.trim() + '\n');
    ...
    it(`dcdx reset (defaults with AMPS configuration for ${name})`, async () => {
      mockExistsSync.mockReturnValue(true);
...
`.trim() + '\n');
    ...
    it(`dcdx reset --database mssql (with AMPS configuration for ${name})`, async () => {
      mockExistsSync.mockReturnValue(true);
      mockReadFileSync.mockReturnValue(getValidPomFileFor(name, tag));
...
`.trim() + '\n');
    ...
    it(`dcdx reset --database mssql --cwd myDirectory (with AMPS configuration for ${name})`, async () => {
      mockExistsSync.mockReturnValue(true);
      mockReadFileSync.mockReturnValue(getValidPomFileFor(name, tag));
...
`.trim() + '\n');
    ...
    it(`dcdx reset --activate-profiles myProfile (with AMPS configuration for ${name})`, async () => {
      mockExistsSync.mockReturnValue(true);
...
`.trim() + '\n');
    ...
    it(`dcdx reset --activate-profiles myProfile --database mssql (with AMPS configuration for ${name})`, async () => {
      mockExistsSync.mockReturnValue(true);
      mockReadFileSync.mockReturnValue(getValidPomFileFor(name, tag, 'myProfile'));
...
`.trim() + '\n');
    ...
    it(`dcdx reset --activate-profiles myProfile --database mssql --cwd myDirectory (with AMPS configuration for ${name})`, async () => {
      mockExistsSync.mockReturnValue(true);
      mockReadFileSync.mockReturnValue(getValidPomFileFor(name, tag, 'myProfile'));
...
`.trim() + '\n');
    ...
    it(`dcdx reset - invalid name`, async () => {
      const name = 'compass';
